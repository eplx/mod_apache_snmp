...
printf("\n\n 2) Checking HTTP /ap2_snmp location access - 127.0.0.1 %s",DEFAULT_PORT);
send_http_to_local("127.0.0.1",DEFAULT_PORT,"/ap2_snmp");
...
// conexion
	...
	serv_addr.sin_port = htons(atol(DEFAULT_PORT));		// Port
